...
<body>
    ...
    <script>
        ...
        window.confirmDelete = function (redirect) {
            if (confirm("Ingin menghapus data ini?")) {
                window.location.href = redirect;
            }
        };

        // Init DataTable — run immediately, no DOMContentLoaded needed
        if (document.getElementById('myTable')) {
            new DataTable('#myTable', { responsive: true, pageLength: 25 });
        }
        document.querySelectorAll('.myTable').forEach(function (el) {
