...
<div style="background-color: rgba(0,0,0,0.2);" class="w-full h-full absolute top-0 left-0 flex flex-row justify-center items-center p-2 hidden z-[10]" id="cart-modal">
